...
class CarResourceIT {
    ...
    private static final Integer DEFAULT_NUMBER_OF_CAR = 1;
    private static final Integer UPDATED_NUMBER_OF_CAR = 2;

    private static final String DEFAULT_CAR_MADE_BY = "AAAAAAAAAA";
    private static final String UPDATED_CAR_MADE_BY = "BBBBBBBBBB";
    ...
    public static Car createEntity(EntityManager em) {
        Car car = new Car().carName(DEFAULT_CAR_NAME).numberOfCar(DEFAULT_NUMBER_OF_CAR).carMadeBy(DEFAULT_CAR_MADE_BY);
        return car;
    }
    ...
    public static Car createUpdatedEntity(EntityManager em) {
        Car car = new Car().carName(UPDATED_CAR_NAME).numberOfCar(UPDATED_NUMBER_OF_CAR).carMadeBy(UPDATED_CAR_MADE_BY);
        return car;
    }
    ...
    void createCar() throws Exception {
        ...
        assertThat(testCar.getNumberOfCar()).isEqualTo(DEFAULT_NUMBER_OF_CAR);
        assertThat(testCar.getCarMadeBy()).isEqualTo(DEFAULT_CAR_MADE_BY);
    }
    ...
    void getAllCars() throws Exception {
        ...
        restCarMockMvc
            ...
            .andExpect(jsonPath("$.[*].numberOfCar").value(hasItem(DEFAULT_NUMBER_OF_CAR)))
            .andExpect(jsonPath("$.[*].carMadeBy").value(hasItem(DEFAULT_CAR_MADE_BY)));
    }
    ...
    void getCar() throws Exception {
        ...
        restCarMockMvc
            ...
            .andExpect(jsonPath("$.numberOfCar").value(DEFAULT_NUMBER_OF_CAR))
            .andExpect(jsonPath("$.carMadeBy").value(DEFAULT_CAR_MADE_BY));
    }
    ...
    void putExistingCar() throws Exception {
        ...
        updatedCar.carName(UPDATED_CAR_NAME).numberOfCar(UPDATED_NUMBER_OF_CAR).carMadeBy(UPDATED_CAR_MADE_BY);
        ...
        assertThat(testCar.getNumberOfCar()).isEqualTo(UPDATED_NUMBER_OF_CAR);
        assertThat(testCar.getCarMadeBy()).isEqualTo(UPDATED_CAR_MADE_BY);
    }
    ...
    void partialUpdateCarWithPatch() throws Exception {
        ...
        partialUpdatedCar.numberOfCar(UPDATED_NUMBER_OF_CAR).carMadeBy(UPDATED_CAR_MADE_BY);
    ...
    void fullUpdateCarWithPatch() throws Exception {
        ...
        partialUpdatedCar.carName(UPDATED_CAR_NAME).numberOfCar(UPDATED_NUMBER_OF_CAR).carMadeBy(UPDATED_CAR_MADE_BY);
