package com.automobil.co.web.rest;
...
import com.automobil.co.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.automobil.co.domain.Car}.
 */
@RestController
@RequestMapping("/api")
public class CarResource {
    ...
    private static final String ENTITY_NAME = "automobileApplicationCar";
